...
export const mockWarRoomData: WarRoomData = {
  ...
  organization: {
    workforceMap: [
      {
        squadId: "copywriting",
        squadName: "Squad de Copywriting (Coracao Intelectual)",
        mission: "Criar, validar e evoluir Big Idea e Mecanismo Unico com base em dados de performance.",
        roles: [
          { title: "Chief Copy Officer (CCO)", headcount: 1, criticality: "critical" },
          { title: "Copywriter Senior", headcount: 2, criticality: "critical" },
          { title: "Copywriter Junior", headcount: 3, criticality: "high" },
          { title: "Especialista de Pesquisa", headcount: 1, criticality: "high" },
          { title: "Copy Editor", headcount: 1, criticality: "high" },
        ],
      },
      {
        squadId: "trafficData",
        squadName: "Squad de Trafego e Dados (Motor de Escala)",
        mission: "Escalar ativos vencedores com atribuicao correta e governanca de ROAS real.",
        roles: [
          { title: "Head de Trafego", headcount: 1, criticality: "critical" },
          { title: "Gestor de Trafego Senior", headcount: 2, criticality: "critical" },
          { title: "Gestor de Trafego Junior", headcount: 2, criticality: "high" },
          { title: "Cientista de Dados / BI", headcount: 1, criticality: "high" },
          { title: "Especialista em Atribuicao", headcount: 1, criticality: "critical" },
        ],
      },
      {
        squadId: "creativeProduction",
        squadName: "Squad de Producao Criativa (Fabrica de Ganchos)",
        mission: "Produzir ativos em ritmo industrial mantendo retencao e velocidade de teste.",
        roles: [
          { title: "Diretor de Arte / Motion Designer", headcount: 1, criticality: "high" },
          { title: "Editor de Video (VSL Specialist)", headcount: 1, criticality: "critical" },
          { title: "Editor de Video (Ads/Hooks)", headcount: 2, criticality: "critical" },
          { title: "Videografo / Produtor", headcount: 1, criticality: "high" },
        ],
      },
      {
        squadId: "operationsTech",
        squadName: "Squad de Operacoes e Tecnologia (Blindagem)",
        mission: "Manter integracoes, estabilidade de plataforma e compliance operacional 24/7.",
        roles: [
          { title: "CTO / Diretor de Tecnologia", headcount: 1, criticality: "critical" },
          { title: "Desenvolvedor Full-Stack", headcount: 2, criticality: "critical" },
          { title: "Analista de Compliance", headcount: 1, criticality: "high" },
          { title: "Gerente de Projetos (Agile Coach)", headcount: 1, criticality: "high" },
        ],
      },
      {
        squadId: "commercialCx",
        squadName: "Squad Comercial e Pos-venda (Snipers de Lucro)",
        mission: "Recuperar receita perdida, elevar satisfacao e aumentar valor do cliente.",
        roles: [
          { title: "Head de Vendas / Closer", headcount: 1, criticality: "critical" },
          { title: "SDR / Recuperador de Vendas", headcount: 3, criticality: "high" },
          { title: "Gerente de Customer Experience (CX)", headcount: 1, criticality: "high" },
          { title: "Especialista de Onboarding", headcount: 1, criticality: "high" },
        ],
      },
      {
        squadId: "strategicAdmin",
        squadName: "Setor Administrativo e Estrategico (Tabuleiro)",
        mission: "Proteger caixa, direcionar estrategia de crescimento e expandir networking de ofertas.",
        roles: [
          { title: "CEO / Fundador", headcount: 1, criticality: "critical" },
          { title: "CFO / Diretor Financeiro", headcount: 1, criticality: "critical" },
          { title: "Gerente de Networking", headcount: 1, criticality: "high" },
        ],
      },
    ],
    individualGoals: [
      {
        userName: "Ana",
        roleTitle: "Copywriter Senior",
        squadName: "Copywriting",
        dailyGoal: "Aprovar 2 roteiros de alta conversao com score >= 70.",
        progressPct: 50,
        impactRevenue: 180000,
      },
      {
        userName: "Bia",
        roleTitle: "Copywriter Junior",
        squadName: "Copywriting",
        dailyGoal: "Gerar 8 variacoes de hook + links UTM sem erro.",
        progressPct: 75,
        impactRevenue: 90000,
      },
      {
        userName: "Caio",
        roleTitle: "Gestor de Trafego Senior",
        squadName: "Trafego e Dados",
        dailyGoal: "Escalar 2 ofertas validadas mantendo MER > 2.8.",
        progressPct: 60,
        impactRevenue: 420000,
      },
      {
        userName: "Leo",
        roleTitle: "Gestor de Trafego Junior",
        squadName: "Trafego e Dados",
        dailyGoal: "Subir 12 criativos com nomenclatura padrao e spend correto.",
        progressPct: 66,
        impactRevenue: 130000,
      },
      {
        userName: "Nati",
        roleTitle: "Editor de Video (Ads/Hooks)",
        squadName: "Producao Criativa",
        dailyGoal: "Entregar 5 hooks para ativos em escala.",
        progressPct: 40,
        impactRevenue: 250000,
      },
      {
        userName: "Igor",
        roleTitle: "CTO / Diretor de Tecnologia",
        squadName: "Operacoes e Tecnologia",
        dailyGoal: "Manter integracoes 100% online e incidentes criticos em zero.",
        progressPct: 85,
        impactRevenue: 300000,
      },
      {
        userName: "Rafa",
        roleTitle: "SDR / Recuperador de Vendas",
        squadName: "Comercial e Pos-venda",
        dailyGoal: "Fechar 20 contatos sniper de score 90+.",
        progressPct: 55,
        impactRevenue: 160000,
      },
      {
        userName: "Patricia",
        roleTitle: "CEO / Fundador",
        squadName: "Estrategico",
        dailyGoal: "Aprovar 1 nova parceria de networking para Offers Lab.",
        progressPct: 30,
        impactRevenue: 500000,
      },
    ],
  },
  activityLog: [
